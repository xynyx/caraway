...
{
    // 'static' will allow being able to use this method inside another class 
    // w/o having to initialize DbInitializer again
    public static void InitDb(WebApplication app)
    {
            Console.WriteLine("here");
        // 'using' means disposing of services we've used in this scope once we
        // are finished with the method
